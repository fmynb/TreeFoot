...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func mainTabBarVC() -> ESTabBarController{
        ...
        homeVC.tabBarItem = ESTabBarItem.init(CFBouncesContentView(), title: "", image: UIImage(named: "home"), selectedImage: UIImage(named: "home"))
        recoderVC.tabBarItem = ESTabBarItem.init(CFBouncesContentView(), title: "", image: UIImage(named: "recoder"), selectedImage: UIImage(named: "recoder"))
        archiveVC.tabBarItem = ESTabBarItem.init(CFBouncesContentViewRight(), title: "", image: UIImage(named: "archive"), selectedImage: UIImage(named: "archive"))
        mineVC.tabBarItem = ESTabBarItem.init(CFBouncesContentViewRight(), title: "", image: UIImage(named: "mine"), selectedImage: UIImage(named: "mine"))
